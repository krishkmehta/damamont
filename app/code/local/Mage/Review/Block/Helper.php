...
class Mage_Review_Block_Helper extends Mage_Core_Block_Template
{
    ...
    public function getSummaryHtml($product, $templateType, $displayIfNoReviews)
    {
		...
		if((Mage::getStoreConfig('amazereviews_section/module_config/enabled')==1) && (Mage::getStoreConfig('advanced/modules_disable_output/Apptha_amazereviews')==0)){ 
			
                 $this->_availableTemplates = array(
				  'default' => 'amazereviews/helper/summary.phtml',
        'short'   => 'amazereviews/helper/summary_short.phtml'
