 ...
 * @package     Scandi_MenuManager
 */
class Scandi_MenuManager_Block_Custom extends Mage_Core_Block_Template
{
    /**
     * Menu data tree
     *
    ...
    {
        return "<li  class='flag-menu' >" . $this->getLayout()->createBlock("page/switch")->setTemplate('page/switch/flag_mobile.phtml')
        ->toHtml() . "</li>";
    ...
    protected function __welcomeHtml()
    {
        ...
        if (Mage::getSingleton('customer/session')->isLoggedIn()) :
            $wc .= Mage::getSingleton('customer/session')->getCustomer()->getName()."</div>";
